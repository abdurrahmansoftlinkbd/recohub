      ...
      <div className="flex flex-col lg:flex-row justify-between items-center my-24 lg:h-[620px] xl:h-[520px]">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="collapse collapse-arrow border-t border-b">
            ...
            <div className="collapse-content">
              <p>
                ...
                community members can then share their experiences and recommend
                alternative products based on their personal experience. Each
                recommendation includes detailed reasoning and product
          ...
          <div className="collapse collapse-arrow border-b">
            ...
            <div className="collapse-content">
              <p>
                A good product query includes specific details about the product
                you’re currently using or interested in, your main concerns or
                reasons for seeking alternatives, and what specific features or
                improvements you’re looking for. The more detailed your query,
                the better recommendations you’ll receive from the community.
              </p>
            </div>
          </div>
          {/* 3rd */}
          <div className="collapse collapse-arrow border-b">
            ...
            <div className="collapse-content">
              <p>
                ...
                must include detailed reasoning and comparisons to help validate
                their suggestions.
              </p>
            </div>
          </div>
